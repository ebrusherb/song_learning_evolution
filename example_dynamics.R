...
save(sigma,f_sigma,m_sigma,mut_prob,pop_dens,pop_dens2,file=paste('/homes/ebrush/priv/song_learning_evolution/song_learning_example_killrare_',substr(Date,1,4),'_',substr(Date,6,7),'_',substr(Date,9,10),'.Rdata',sep=''))

...
k1_vals = c(7,7,15,21,31)
k2_vals = c(35,25,21,21,31)
...
saveit(sigma2_vals=sigma2_vals,sigmax2=sigmax2,sigmay2=sigmay2,k1_vals=k1_vals,k2_vals=k2_vals,equilibrium=equilibrium,var_mat=var_mat,mut_prob=mut_prob,file='/homes/ebrush/priv/song_learning_evolution/step_song_equilibrium.Rdata')

...
saveit(sigma2_vals=sigma2_vals,sigmax2=sigmax2,sigmay2=sigmay2,k1_vals=k1_vals,k2_vals=k2_vals,equilibrium=equilibrium,var_mat=var_mat,mut_prob=mut_prob,file='/homes/ebrush/priv/song_learning_evolution/step_pref_equilibrium.Rdata')

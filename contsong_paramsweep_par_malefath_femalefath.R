...
while(t <= Tsteps){
	...
	song_beforemut = matrix(0,Nm)
	for(i in 1:Nm){
		song_beforemut[i] = int(pxy[i,]) #probability of males being born
	}
	song_aftermut = matrix(0,Nm)

...
saveit(p1=p1,equilibrium=equilibrium,excess_kurt_vals=excess_kurt_vals,mut_prob_vals=mut_prob_vals,sigmax2=sigmax2,sigma2=sigma2,sigmay2=sigmay2,file='/homes/ebrush/priv/song_learning_evolution/pearson_kurtosis.Rdata')

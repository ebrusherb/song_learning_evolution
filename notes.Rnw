...
Mathematically, each male has a song $x\in \R$ and each female has a preference $y\in\R$. Her preference function 
...
<<explanation, echo = TRUE>>=
@

<< plot_female_tots, fig.width=5, fig.height=5, fig.cap = 'Available mates as a function of female preference.' >>=
plot(frange, female_tots, type='l', xlab = 'Preferences',ylab = 'Available mates')
@

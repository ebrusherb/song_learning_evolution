...
\usepackage[textwidth=8in,textheight=10.7in]{geometry}
\usepackage{graphicx}
...
%\begin{align*}
%\bar{\Sigma}_\x{m}^{-1}&=\left(\begin{array}{cccc}\frac{\sigma^2+(1-\rho_\x{m}^2)\sigma_{\x{m}x}^2}{(1-\rho_\x{m}^2)\sigma_{\x{m}x}^2\sigma^2} & \frac{-\rho_\x{m}}{(1-\rho_\x{m}^2)\sigma_{\x{m}x}\sigma_{\x{m}y}} \\ \frac{-\rho_\x{m}}{(1-\rho_\x{m}^2)\sigma_{\x{m}x}\sigma_{\x{m}y}} & \frac{1}{(1-\rho_\x{m}^2)\sigma_{\x{m}y}^2} \end{array}\right)
%\\ \bar{\mu}_{\x{m}x}-\vec{x}_{\x{m}}&=\left(\begin{array}{cc}\frac{\sigma^2\mu_{\x{m}x}}{\sigma^2+\sigma_{\x{m}x}^2}+\frac{\sigma_{\x{m}x}^2y_2}{\sigma^2+\sigma_{\x{m}x}^2}-x_1 \\ \mu_{\x{m}y}+\frac{\rho_\x{m}\sigma_{\x{m}x}\sigma_{\x{m}y}}{\sigma^2+\sigma_{\x{m}x}^2}(y_2-\mu_{\x{m}x})-y_1\end{array}\right)
%\\&=\left(\begin{array}{cc}\frac{\sigma_{\x{m}x}^2}{\sigma^2+\sigma_{\x{m}x}^2}\left(y_2+\frac{\sigma^2}{\sigma_{\x{m}x}^2}\mu_{\x{m}x}-x_1\right) \\ \frac{\rho_\x{m}\sigma_{\x{m}x}\sigma_{\x{m}y}}{\sigma^2+\sigma_{\x{m}x}^2}\left(y_2+\frac{\sigma^2+\sigma_{\x{m}x}^2}{\rho_\x{m}\sigma_{\x{m}x}\sigma_{\x{m}y}}\mu_{\x{m}y}-\mu_{\x{m}x}-y_1\right)\end{array}\right)
%\\&=\left(\begin{array}{cc}\frac{\sigma_{\x{m}x}^2}{\sigma^2+\sigma_{\x{m}x}^2} & 0 \\ 0 & \frac{\rho_\x{m}\sigma_{\x{m}x}\sigma_{\x{m}y}}{\sigma^2+\sigma_{\x{m}x}^2} \end{array}\right)\left(\begin{array}{cc}y_2+\frac{\sigma^2}{\sigma_{\x{m}x}^2}\mu_{\x{m}x}-x_1 \\ y_2+\frac{\sigma^2+\sigma_{\x{m}x}^2}{\rho_\x{m}\sigma_{\x{m}x}\sigma_{\x{m}y}}\mu_{\x{m}y}-\mu_{\x{m}x}-y_1 \end{array}\right)
%\\ \Rightarrow (\bar{\mu}_{\x{m}x}-\vec{x}_{\x{m}})^T\bar{\Sigma}_\x{m}^{-1}(\bar{\mu}_{\x{m}x}-\vec{x}_{\x{m}})&=\left(\begin{array}{cc}y_2+\frac{\sigma^2}{\sigma_{\x{m}x}^2}\mu_{\x{m}x}-x_1 & y_2+\frac{\sigma^2+\sigma_{\x{m}x}^2}{\rho_\x{m}\sigma_{\x{m}x}\sigma_{\x{m}y}}\mu_{\x{m}y}-\mu_{\x{m}x}-y_1 \end{array}\right)\left(\begin{array}{cc}\frac{\sigma_{\x{m}x}^2}{\sigma^2+\sigma_{\x{m}x}^2} & 0 \\ 0 & \frac{\rho_\x{m}\sigma_{\x{m}x}\sigma_{\x{m}y}}{\sigma^2+\sigma_{\x{m}x}^2} \end{array}\right)\bar{\Sigma}_{\x{m}}^{-1}\left(\begin{array}{cc}\frac{\sigma_{\x{m}x}^2}{\sigma^2+\sigma_{\x{m}x}^2} & 0 \\ 0 & \frac{\rho_\x{m}\sigma_{\x{m}x}\sigma_{\x{m}y}}{\sigma^2+\sigma_{\x{m}x}^2} \end{array}\right)\left(\begin{array}{cc}y_2+\frac{\sigma^2}{\sigma_{\x{m}x}^2}\mu_{\x{m}x}-x_1 \\ y_2+\frac{\sigma^2+\sigma_{\x{m}x}^2}{\rho_\x{m}\sigma_{\x{m}x}\sigma_{\x{m}y}}\mu_{\x{m}y}-\mu_{\x{m}x}-y_1 \end{array}\right)
%\end{align*}
%\begin{align*}
%\\\left(\begin{array}{cc}\frac{\sigma_{\x{m}x}^2}{\sigma^2+\sigma_{\x{m}x}^2} & 0 \\ 0 & \frac{\rho_\x{m}\sigma_{\x{m}x}\sigma_{\x{m}y}}{\sigma^2+\sigma_{\x{m}x}^2} \end{array}\right)\bar{\Sigma}_{\x{m}}^{-1}\left(\begin{array}{cc}\frac{\sigma_{\x{m}x}^2}{\sigma^2+\sigma_{\x{m}x}^2} & 0 \\ 0 & \frac{\rho_\x{m}\sigma_{\x{m}x}\sigma_{\x{m}y}}{\sigma^2+\sigma_{\x{m}x}^2} \end{array}\right)&=\left(\begin{array}{cc}\frac{\sigma_{\x{m}x}^2}{(1-\rho_\x{m}^2)(\sigma^2+\sigma_{\x{m}x}^2)^2}+\frac{\sigma_{\x{m}x}^4}{(\sigma^2+\sigma_{\x{m}x}^2)^2\sigma^2} & \frac{-\rho_\x{m}^2\sigma_{\x{m}x}^2}{(1-\rho_\x{m}^2)(\sigma^2+\sigma_{\x{m}x}^2)^2} \\ \frac{-\rho_\x{m}^2\sigma_{\x{m}x}^2}{(1-\rho_\x{m}^2)(\sigma^2+\sigma_{\x{m}x}^2)^2} & \frac{\sigma_{\x{m}x}^4\sigma_{\x{m}y}^2}{(1-\rho_\x{m}^2)(\sigma^2+\sigma_{\x{m}x}^2)^2}\end{array}\right)
%\end{align*}
